...
GnuStepa. Jest to pakiet pozwalający na integrację między Javą a
Objective-C. Głównym celem JIGS jest umożliwienie programistom Javy
używania bibliotek GNUstepa z poziomu Javy.
